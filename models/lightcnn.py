...
class network_29layers_v2(nn.Module):
    def __init__(self, block, layers, num_classes=79077):
        ...
        for index, num_class in enumerate(num_classes):
            #self.fc_dict["self.full_connector_" + str(index)] = nn.Linear(256, num_class, bias=False)
            #locals()["self.full_connector_" + str(index)] = nn.Linear(256, num_class, bias=False)
            setattr(self, "self.full_connector_" + str(index), nn.Linear(256, num_class, bias=False))
